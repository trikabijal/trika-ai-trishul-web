      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="mt-10 mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
              <h3 className="text-xl font-bold mb-4 text-center">Try AXONO Now</h3>
              <p className="mb-4 text-center">
                Connect your Google account to see how AXONO can extract tasks from your meeting summaries.
              ...
              <p className="mt-4 text-xs text-gray-500 text-center">
                We only request read access to help organize your meeting summaries. 
